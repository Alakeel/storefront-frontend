...
Run `ng serve --port 4000` to build and run the development server.Then navigate to `http://localhost:4000/`. The application will automatically reload if you change any of the source files.
...
Abdullah Alakeel [@Linkedin](http://alakeel.net)

<!-- markdownlint-configure-file { "MD022": false, "MD024": false, "MD030": false,
"MD031": false, "MD040": false, "MD032": false} -->
